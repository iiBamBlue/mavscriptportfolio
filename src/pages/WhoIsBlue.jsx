  ...
  return (
    <section className="whoisblue-section">
      ...
      <p className="whoisblue-description">
        Blue is a creative developer passionate about blending design and code
        to craft unique digital experiences. With a background in both art and
        technology, Blue brings a poetic touch to every project.
      </p>
